$(function(){
  ...
  $(".your-hand").on("click", ".hand", function(){
  ...
  function displayyourhand(){
    ...
    for(var i = 0; i < YOUR_HAND.length; i++) {
      $('.your-hand').append("<img id='" + i + "' class='hand' src='img/" + YOUR_HAND[i] + ".jpg' style='width:80px' />");
    }

    for(var i = 0; i < OPPONENT_HAND.length; i++) {
      $('.bob-hand').append("<img src='img/rock.png' style='width:80px' />");
    }
  }
